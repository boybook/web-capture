...
function App() {
    ...
    return (
        <div className="web-capture-app">
            ...
            <a href="https://github.com/boybook/web-capture" class="about">
                <svg height="20" width="20" aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" class="octicon octicon-mark-github v-align-middle" fill="white">
